                      ...
                      <div className=" d-flex mt-5 justify-content-between align-items-center">
                        <h6 style={{ borderRadius: "5px" }}>
                          <img
                            ...
                            loading="lazy"
                          />
                          {props.data.name} <a href={"mailto:"+props.data.email} target="_blank"  style={{color:"grey" , backgroundColor: "#b6b6dc21",
    padding: "3px",
    borderRadius: "5px"}}> {props.data.email} </a>
                        </h6>
                        <div>
                          Condition : &nbsp;
                      ...
                      <div className="border p-3 mt-4">
                        ...
                        <dl className="row">
                          ...
                          <dd className="col-sm-9">
                            <dl className="row">
                              <dt className="col-sm-4">{props.data.DPV}</dt>
                          ...
                          <dt className="col-sm-3">ADPF : </dt>
                          <dd className="col-sm-9">
                            <dl className="row">
                              <dt className="col-sm-4">{props.data.ADPF}</dt>
                              <dd className="col-sm-8 text-muted">
                                Average of Number of Defects per Frame.
                              </dd>
                            </dl>
                          </dd>
                          ...
                          <dt className="col-sm-3">DPV : </dt>
                          <dd className="col-sm-9">
                            <dl className="row">
                              <dt className="col-sm-4">{props.data.DPV}</dt>
                              <dd className="col-sm-8 text-muted">
                                Total number of Defects per Video.
                              </dd>
                            </dl>
                          </dd>
                          ...
                          <dt className="col-sm-3">Video Length : </dt>
                          <dd className="col-sm-9">
                            <dl className="row">
                              <dt className="col-sm-4">{props.data.video_length+" sec."}</dt>
                              <dd className="col-sm-8 text-muted">
                      ...
                      <h4 className="mt-4 mb-4">Bar Chart</h4>
                      <div className="modal-body"><Bar_chart data={props.data.DPS}/></div>
                      <div className="border p-3 mt-4">
                      ...
                      <div>
                        <a  href={window.location.origin+"/view_media?id="+props.id} target="_blank" type="button" class="btn btn-outline-secondary   btn-block btn-sm" data-mdb-ripple-color="#000000" > View Video </a>
