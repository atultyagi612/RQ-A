...
import '../Explore/dashboard.css'
import Likes from './Likes'
import Comments from './Comments'
import Viewuser from '../Explore/Viewuser'
...
className="w-100" alt='alternate' />)
  ...
  return (
    ...
    <div className="col-md-12 col-xl-10">
      ...
      <a type="button" className="btn btn-outline-secondary    btn-sm " href={window.location.origin+"/download?id="+item.id} target="_blank" style={{cursor:'pointer'}}><span className="far fa-circle-down ms-3 " ></span></a>
      </div>
              </div>
            </div>
          </div>
